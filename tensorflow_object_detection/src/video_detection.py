...
# 可能要改的内容
######################################################
PATH_TO_CKPT = '/home/zhu/catkin_wss/src/tensorflow_object_detection/object_detection/outputing/frozen_inference_graph.pb'   # 模型及标签地址
PATH_TO_LABELS = '/home/zhu/catkin_wss/src/tensorflow_object_detection/object_detection/data/frame_label_map.pbtxt'
