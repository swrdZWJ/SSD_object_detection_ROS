...
#        
#        self.PATH_TO_CKPT = model_path + MODEL_NAME +'/frozen_inference_graph.pb'
#        
#        self.PATH_TO_LABELS = os.path.join(model_path + '/data', 'frame_label_map.pbtxt')
...
#		self.vfc=0
        ...
        self.PATH_TO_CKPT = '/home/zhu/catkin_ws/src/tensorflow_object_detection/object_detection/outputing/frozen_inference_graph.pb'
        self.PATH_TO_LABELS = '/home/zhu/catkin_ws/src/tensorflow_object_detection/object_detection/data/frame_label_map.pbtxt'
